...
__webpack_require__.d(__webpack_exports__, {
  gM: () => (/* binding */ MinimogLibs)
});

// UNUSED EXPORTS: MinimogEvents, MinimogSettings, MinimogStrings, MinimogTheme
...
// EXTERNAL MODULE: ./src/js/libs/loadjs.js
var loadjs = __webpack_require__(280);
;// CONCATENATED MODULE: ./src/js/global.js


window.MinimogEvents = window.MinimogEvents || new Event();
...
;// CONCATENATED MODULE: ./node_modules/photoswipe/dist/photoswipe.esm.js
/*!
...
function photoswipe_esm_getElementsFromOption(option, legacySelector) {
  let parent = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : document;
  /** @type {HTMLElement[]} */
  let elements = [];
  if (option instanceof Element) {
...
;// CONCATENATED MODULE: ./src/js/libs/photoswipe.js
/* provided dependency */ var MinimogLibs = __webpack_require__(272)["gM"];



MinimogLibs.PhotoSwipeLightbox = PhotoSwipeLightbox;
MinimogLibs.PhotoSwipeLightbox.PhotoSwipe = PhotoSwipe;
})();
